...
st.write('[![view source code ](https://img.shields.io/badge/view_source_code-gray?logo=github)](https://github.com/Pruthvirajsinh-Zala/ai-chatbot/blob/main/streamlit_app.py)')
